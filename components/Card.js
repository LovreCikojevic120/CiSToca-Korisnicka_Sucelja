    ...
    <div className="card-item">
      ...
      {showConfirm ? 
        <div className="flex flex-col items-center my-2 rounded-xl pb-4 font-semibold">
          ...
          <div>
            <button className="bg-emerald-500 text-white active:bg-red-500 text-sm w-20 h-8 rounded shadow outline-none focus:outline-none mr-6" 
              onClick={() => deletePost(post.postID)}>Izbriši
            </button>
            <button className="bg-red-500 text-white active:bg-red-500 text-sm w-20 h-8 rounded shadow outline-none focus:outline-none" 
